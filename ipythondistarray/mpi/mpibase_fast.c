/* Generated by Cython 0.9.6.10b on Sat Jan 26 11:05:47 2008 */
...
/* Declarations from mpibase_fast */

/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pxd":3
...
/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pxd":11
...
/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":8
 * 
 * 
 * cdef class Comm:             # <<<<<<<<<<<<<< 
 *             
...
/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":30
 *         pass
 *         
 * cdef class Group:             # <<<<<<<<<<<<<< 
 * 
...
/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":10
 * cdef class Comm:
 *             
 *     def __init__(self, comm=None):             # <<<<<<<<<<<<<< 
 *         if comm is None:
...
static int __pyx_pf_12mpibase_fast_4Comm___init__(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_v_comm = __pyx_k3;
  if (unlikely(!PyArg_ParseTupleAndKeywords(__pyx_args, __pyx_kwds, "|O", __pyx_argnames, &__pyx_v_comm))) return -1;
  Py_INCREF(__pyx_v_self);
  Py_INCREF(__pyx_v_comm);

  /* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":11
 *             
 *     def __init__(self, comm=None):
 *         if comm is None:             # <<<<<<<<<<<<<< 
 *             self.comm
 ...
 */
  ...
  if (__pyx_1) {
    ...
    /* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":12
 *     def __init__(self, comm=None):
 *         if comm is None:
 *             self.comm             # <<<<<<<<<<<<<< 
 *             
...
/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":14
 *             self.comm
 *             
 *     cdef MPI_Group c_get_group(self):             # <<<<<<<<<<<<<< 
 *         pass
...
/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":17
 *         pass
 *     
...
static  int __pyx_f_12mpibase_fast_4Comm_c_get_size(struct __pyx_obj_12mpibase_fast_Comm *__pyx_v_self) {
  ...
  /* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":19
 *     cdef int c_get_size(self):
 *         cdef int size, ierr
 *         ierr = MPI_Comm_size(self.comm, &size)             # <<<<<<<<<<<<<< 
 *         return size
 ...
 */
  ...
  /* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":20
 *         cdef int size, ierr
 *         ierr = MPI_Comm_size(self.comm, &size)
 *         return size             # <<<<<<<<<<<<<< 
 *         
...
/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":22
 *         return size
 *         
 *     cdef int c_get_rank(self):             # <<<<<<<<<<<<<< 
 *         cdef int rank, ierr
...
static  int __pyx_f_12mpibase_fast_4Comm_c_get_rank(struct __pyx_obj_12mpibase_fast_Comm *__pyx_v_self) {
  ...
  /* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":24
 *     cdef int c_get_rank(self):
 *         cdef int rank, ierr
 *         ierr = MPI_Comm_rank(self.comm, &rank)             # <<<<<<<<<<<<<< 
 *         return rank
 ...
 */
  ...
  /* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":25
 *         cdef int rank, ierr
 *         ierr = MPI_Comm_rank(self.comm, &rank)
 *         return rank             # <<<<<<<<<<<<<< 
 *         
...
/* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":27
 *         return rank
 *         
 *     cdef MPI_Comm c_clone(self):             # <<<<<<<<<<<<<< 
 *         pass
...
static int __pyx_tp_traverse_12mpibase_fast_Comm(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_12mpibase_fast_Comm(PyObject *o) {
  return 0;
}
...
PyTypeObject __pyx_type_12mpibase_fast_Comm = {
  ...
  0, /*tp_doc*/
  __pyx_tp_traverse_12mpibase_fast_Comm, /*tp_traverse*/
  __pyx_tp_clear_12mpibase_fast_Comm, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
static int __pyx_tp_traverse_12mpibase_fast_Group(PyObject *o, visitproc v, void *a) {
  return 0;
}

static int __pyx_tp_clear_12mpibase_fast_Group(PyObject *o) {
  return 0;
}
...
PyTypeObject __pyx_type_12mpibase_fast_Group = {
  ...
  Py_TPFLAGS_DEFAULT|Py_TPFLAGS_CHECKTYPES|Py_TPFLAGS_BASETYPE|Py_TPFLAGS_HAVE_GC, /*tp_flags*/
  0, /*tp_doc*/
  __pyx_tp_traverse_12mpibase_fast_Group, /*tp_traverse*/
  __pyx_tp_clear_12mpibase_fast_Group, /*tp_clear*/
  0, /*tp_richcompare*/
  0, /*tp_weaklistoffset*/
  0, /*tp_iter*/
  0, /*tp_iternext*/
...
PyMODINIT_FUNC initmpibase_fast(void) {
  ...
  *(void(**)(void))&__pyx_vtable_12mpibase_fast_Comm.c_clone = (void(*)(void))__pyx_f_12mpibase_fast_4Comm_c_clone;
  if (PyType_Ready(&__pyx_type_12mpibase_fast_Comm) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; goto __pyx_L1;}
  if (__Pyx_SetVtable(__pyx_type_12mpibase_fast_Comm.tp_dict, __pyx_vtabptr_12mpibase_fast_Comm) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Comm", (PyObject *)&__pyx_type_12mpibase_fast_Comm) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; goto __pyx_L1;}
  __pyx_ptype_12mpibase_fast_Comm = &__pyx_type_12mpibase_fast_Comm;
  if (PyType_Ready(&__pyx_type_12mpibase_fast_Group) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; goto __pyx_L1;}
  if (PyObject_SetAttrString(__pyx_m, "Group", (PyObject *)&__pyx_type_12mpibase_fast_Group) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; goto __pyx_L1;}
  __pyx_ptype_12mpibase_fast_Group = &__pyx_type_12mpibase_fast_Group;
  /*--- Type import code ---*/
  /*--- Execution code ---*/

  /* "/Users/bgranger/Documents/Computation/IPython/Working/ipythondistarray/trunk/ipythondistarray/mpi/mpibase_fast.pyx":5
 ...
 * 
 */
  __pyx_1 = PyList_New(1); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; goto __pyx_L1;}
  Py_INCREF(__pyx_n_MPI);
  PyList_SET_ITEM(__pyx_1, 0, __pyx_n_MPI);
  __pyx_2 = __Pyx_Import(__pyx_n_mpi4py, __pyx_1); if (unlikely(!__pyx_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
  __pyx_1 = PyObject_GetAttr(__pyx_2, __pyx_n_MPI); if (unlikely(!__pyx_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; goto __pyx_L1;}
  if (PyObject_SetAttr(__pyx_m, __pyx_n_MPI, __pyx_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 5; goto __pyx_L1;}
  Py_DECREF(__pyx_1); __pyx_1 = 0;
